...
class largeint
{
 public:
  ...
  friend const largeint prime(const largeint&, const largeint&, const largeint&);
  /* Fonction qui génère un nombre premier compris entre arg1 et arg2 et premier avec arg3 */

  friend const largeint prime(const USHORT, const largeint&);
  /* Fonction qui génère un nombre premier de arg1 bits et premier avec arg2 */

  friend const largeint prime(const USHORT);
